...
if __name__ == "__main__":
    ...
    if opt.do_random:
        fake_motion, classes = trainer.evaluate(prior_net, decoder, veloc_net, opt.num_samples)
        ...
        fake_motion, _ = trainer.evaluate(prior_net, decoder, veloc_net, num_samples, category_oh)
        fake_motion = fake_motion.numpy()
